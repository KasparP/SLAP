function opts = defaultOpts_Voltage

opts.tau = 0.1;                  %'Decay time constant';
...
opts.minNumIters = 75;          %'Minimum number of iterations';
opts.darkNoise = 0.01;          %'Dark noise, in photons, added to all expected photon rates';
...
opts.offFocusSpikes = false;     %Global spikes outside the focal plane; set to true if out-of-focus background can produce large coherent signals
...
opts.clipDFF = 0.5;             %maximum DFF, set to Inf to not clip
end