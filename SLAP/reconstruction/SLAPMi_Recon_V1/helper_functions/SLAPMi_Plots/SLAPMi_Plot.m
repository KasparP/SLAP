...
opts.MovieType = {'''dPhotons'''; '''dFF'''; '''Zscore'''};
...
hs = annotation('line', [.96-linelength 0.96+linelength], [0.01, 0.01]);
hs.LineWidth = 5;
hs.Color = 'w';
hScalebarLabel = text(ax,0.96,0.02, '10 {\mu}m', 'verticalalignment', 'baseline', 'units', 'normalized', 'horizontalalignment', 'center', 'color', 'w');
